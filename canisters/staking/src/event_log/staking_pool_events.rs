...
pub fn save_change_staking_pool_status_event_log(id: StakingPoolId, status: StakingPoolStatus) {
  EventLog::new(EventType::ChangeStakingPoolStatus(id, status))
    .save_to_stable_memory()
}