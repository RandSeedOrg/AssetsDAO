...
pub struct RemoveApprovalArgs {
  pub fee: Option<candid::Nat>,
  pub from_subaccount: Option<serde_bytes::ByteBuf>,
  pub spender: serde_bytes::ByteBuf,
}
...
pub struct TipOfChainRes {
  pub certification: Option<serde_bytes::ByteBuf>,
  pub tip_index: u64,
}
...
impl Service {
  ...
  pub async fn icrc_21_canister_call_consent_message(&self, arg0: ConsentMessageRequest) -> Result<(Result1,)> {
  ...
  pub async fn remove_approval(&self, arg0: RemoveApprovalArgs) -> Result<(Result2,)> {
    ic_cdk::call(self.0, "remove_approval", (arg0,)).await
  }
  ...
  pub async fn tip_of_chain(&self) -> Result<(TipOfChainRes,)> {
    ic_cdk::call(self.0, "tip_of_chain", ()).await
  }
