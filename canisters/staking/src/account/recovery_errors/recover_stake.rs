...
use types::{date::YearMonthDay, entities::{add_indexed_id, remove_indexed_id}};

use crate::{account::{crud_utils::{query_user_in_stake_accounts, save_stake_account_to_stable_memory}, guard_keys::get_recovery_stake_guard_key, stable_structures::{StakingAccount, StakingAccountStatus}, transport_structures::StakingAccountVo, STAKING_RECOVERABLE_ERROR_ACCOUNT_INDEX_MAP, STAKING_UNSTAKE_ON_DAY_ACCOUNT_INDEX_MAP}, event_log::{stake_and_unstake_events::save_stake_event, transfer_events::{save_stake_transfer_fail_event, save_stake_transfer_ok_event, save_stake_transfer_start_event}}, on_chain::transfer::transfer_from_staking_account_to_staking_pool, parallel_guard::EntryGuard, pool::crud_utils::query_staking_pool_by_id};
...
pub async fn recover_stake_error(account: &StakingAccount, pay_center_onchain_tx_id: BlockIndex, pay_center_tx_id: u64) -> Result<StakingAccountVo, String> {
  // Entrance guard
