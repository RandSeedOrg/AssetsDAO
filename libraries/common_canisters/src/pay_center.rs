...
impl Service {
  pub async fn dissolve(&self, arg0: Principal, arg1: u64, arg2: u64, arg3: String, arg4: u64) -> Result<(Result2,)> {
  ...
  pub async fn update_account_bonus(
    ...
    ic_cdk::call(self.0, "update_account_bonus", (arg0, arg1, arg2, arg3, arg4, arg5, arg6)).await
  }
}
